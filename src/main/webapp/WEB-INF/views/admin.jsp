        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:load('create_blog');">写博客</a></dd>
                        <dd class="layui-this"><a href="javascript:load('blog_admin');">文章管理</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item layui-nav-itemed"><a href="javascript:load('comment_admin');">评论管理</a></li>
                <li class="layui-nav-item layui-nav-itemed"><a href="javascript:load('type_admin');">个人分类管理</a></li>
            </ul>
        </div>
